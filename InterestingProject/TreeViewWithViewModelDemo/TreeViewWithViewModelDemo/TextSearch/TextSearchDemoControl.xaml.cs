...
namespace TreeViewWithViewModelDemo.TextSearch
{
    ...
    {
        FamilyTreeViewModel _familyTree;  
        ...
        private void changefamily(object sender, System.Windows.RoutedEventArgs e)
        {
            // Get raw family tree data from a database.
            Person rootPerson = Database.GetAnotherFamilyTree();
